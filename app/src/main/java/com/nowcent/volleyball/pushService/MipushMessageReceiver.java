...
import com.nowcent.volleyball.activity.PermissionActivity;
...
public class MipushMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        Log.v(VolleyballApplication.TAG,
        ...
        msg.obj = log;
        VolleyballApplication.getHandler().sendMessage(msg);
    }
    ...
    public void onRequirePermissions(Context context, String[] permissions) {
        ...
        Log.e(VolleyballApplication.TAG,
